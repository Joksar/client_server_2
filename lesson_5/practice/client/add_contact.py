...
# Диалог выбора контекста для добавления
class AddContactDialog(QDialog):
    def __init__(self, transport, database):
        ...
        # Делаем окно модальным (поверх других)
        self.setModal(True)
    ...
    def possible_contacts_update(self):
        ...
        # Удаляем себя из списка, чтобы нельзя было добавить себя
    ...
    def update_possible_contacts(self):
        try:
            ...
            logger.debug('Обновленеи списка пользователей с сервера выполнено.')
            self.possible_contacts_update()
