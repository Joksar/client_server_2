...
class ClientDatabase:
    ...
    # Класс - отображение таблицы истрии сообщений
    ...
    def __init__(self, name):
        # Нужно сделать отдельную бд для каждого клиента
        # Клиент мультипоточный => нужно отключить проверки на подключение с разных потоков
        ...
        # Необходимо очистить таблицу контактов, т.к при запуске она подгружается с сервера.
