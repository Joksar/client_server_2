...
# GUI - создание таблицы QModel для отобрадения в окне программы
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        # Надпись о том, что ниже список подключенных клиентов
        ...
        # Последним параметром отображается окно
        self.show()
